...
public class App 
{
    private static int min_rep_len = 35;//match threshold m, must be consisted with the compression process
...
//        System.out.println(diff_pos_loc_len);
    ...
    public static void main( String[] args ) throws IOException {
        ...
        String uri="F:\\geneExp\\ChrY\\HG00101-m-00000";//Path to the file to be extracted
        Path path = new Path(uri);
        SequenceFile.Reader.Option opt = SequenceFile.Reader.file(path);
        File refFile = new File("F:\\geneExp\\ChrY\\chrY.fa");//Reference file path, must be consistent with the compressed reference file
        File resultfFile = new File("F:\\geneExp\\ChrY\\Na2.fa");//Output path
        ...
        try {
            ...
            while (reader.next(key, value)) {
                ...
                is = new ByteArrayInputStream(bt);//Instantiate this array object! Enter from the byte array
                readCompressedFile();
            }
